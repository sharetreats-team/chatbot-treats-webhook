...
public class PayResultButtons {
    ...
    public static List<PayResultButtons> of(GiftHistory giftHistory) {
        return List.of(
                ...
                ButtonsForButton.of(6, 1, "open-url", giftHistory.getProduct().getDiscountShop(), "#2db9b9", "<font color=#ffffff>see participating stores</font>", "small", "middle", "middle"),
                ButtonsForButton.of(6, 1, "open-url", "https://www.sharetreats.ph/welcome", "#2db9b9", "<font color=#ffffff>terms of use</font>", "small", "middle", "middle"));
    }
