...
@Component
public class SendBrandKeyboardMessage extends ResponseEvent {
    ...
    public ResponseEntity<?> execute(String callback) {
        BrandResponse response = findBrandListForReceiverId(getIdFromSender(callback));
    ...
    public BrandResponse findBrandListForReceiverId(String id) {
        BrandKeyboard keyboard = BrandKeyboard.of(brandService.createBrandButtons());
